...
A personal desktop app for tracking my games backlog and history — built as a portfolio project
and a hands-on way to sharpen front-end (and some backend/AI) development skills.

Originally based on a personal spreadsheet, reimagined as a polished local app.
